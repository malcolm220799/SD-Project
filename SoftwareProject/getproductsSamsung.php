    ...
    <body>
        ...
        <div class="container">
            ...
            if (!empty($_SESSION['userId'])) {
                ...
                $query = "SELECT productName, price, categoryId, brandId,img FROM tbl_products WHERE categoryId LIKE '2' && brandId LIKE '1';";
            ...
            <div class="form-group row justify-content-between">
                ...
                <a class="btn btn-danger" href="removeproducts.php">Remove</a>
            </div>
        </div>
    </body>
</html>