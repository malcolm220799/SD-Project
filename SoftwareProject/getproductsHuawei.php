    ...
    <body>
        ...
        <div class="container">
            ...
            if (!empty($_SESSION['userId'])) {
                ...
                $query = "SELECT productName, price, categoryId, brandId,img FROM tbl_products WHERE categoryId LIKE '2' && brandId LIKE '5'";
